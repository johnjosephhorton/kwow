...
ggplot(data = na.omit(subset(df.wage,log(tot.emp) > 12)),  aes(y = Input.Title, x = w.trend.mu)) + geom_point()
...
#write.image("../../writeup/plots/knowlege_by_occupation", g.know, width = 5, heigh = 10)
