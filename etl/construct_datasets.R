...
national.df <- import.top.national("raw/national_M2012_dl.csv", 99)
# Impute volume trend estimations
national.df <- import.occupation.trend("raw/occupation.table.1.2.csv", national.df)
# Impute education requirements
national.df <- import.education("raw/education.categories.csv", national.df)
# Data from MTurk
mturk.df <- import.mturk("raw/mturk_output.csv")
nrow(mturk.df)
head(mturk.df)
...
saveRDS(mturk.df, "transformed/mturk_cooked.rds")
